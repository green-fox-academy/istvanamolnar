...
export class WeatherInfoComponent implements OnInit {
  ...
  ngOnInit() {
    this.getWeatherDetails('Ujszilvas');
    this.visible = true;
  }
  ...
  getWeatherDetails(city: string) {
    this.weatherInfoService.getWeatherInfo(city).subscribe(
      ...
      this.city.icon = `http://openweathermap.org/img/w/${data['weather'][0].icon}.png`;
      this.city.country = this.getCountryName(data['sys'].country);
      }),
      error => {
        this.visible = false;
      } 
