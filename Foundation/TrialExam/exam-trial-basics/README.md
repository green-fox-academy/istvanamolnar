...
Math.random() returns floating-point between 0 and 1 (inclusive of 0, but not 1). 

### What is a ternary operator? How does it work?

A conditional operator, three arguments: 1 condition & 2 expresions (true or false)
